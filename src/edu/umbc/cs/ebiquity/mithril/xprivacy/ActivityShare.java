...
public class ActivityShare extends ActivityBase {
	...
	public static final String ACTION_EXPORT = "edu.umbc.cs.ebiquity.mithril.xprivacy.action.EXPORT";
	public static final String ACTION_IMPORT = "edu.umbc.cs.ebiquity.mithril.xprivacy.action.IMPORT";
	public static final String ACTION_FETCH = "edu.umbc.cs.ebiquity.mithril.xprivacy.action.FETCH";
	public static final String ACTION_SUBMIT = "edu.umbc.cs.ebiquity.mithril.xprivacy.action.SUBMIT";
	public static final String ACTION_TOGGLE = "edu.umbc.cs.ebiquity.mithril.xprivacy.action.TOGGLE";
