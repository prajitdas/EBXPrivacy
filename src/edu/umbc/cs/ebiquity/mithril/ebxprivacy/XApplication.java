...
public class XApplication extends XHook {
	...
	public static String ACTION_MANAGE_PACKAGE = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.ACTION_MANAGE_PACKAGE";
	public static String PERMISSION_MANAGE_PACKAGES = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.MANAGE_PACKAGES";
