...
public class ActivityShare extends ActivityBase {
	...
	public static final String HTTP_BASE_URL = "http://crowd.ebxprivacy.eu/";
	public static final String HTTPS_BASE_URL = "https://crowd.ebxprivacy.eu/";

	public static final int cSubmitLimit = 10;
	public static final int cProtocolVersion = 4;

	public static final String ACTION_EXPORT = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.EXPORT";
	public static final String ACTION_IMPORT = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.IMPORT";
	public static final String ACTION_FETCH = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.FETCH";
	public static final String ACTION_SUBMIT = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.SUBMIT";
	public static final String ACTION_TOGGLE = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.TOGGLE";
	...
	public void fileChooser() {
		...
		Uri uri = Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/.ebxprivacy/");
