	...
	protected void after(XParam param) throws Throwable {
		...
		case getPackageManager:
			if (param.getResult() != null)
				EBXPrivacy.handleGetSystemService("PackageManager", param.getResult().getClass().getName(), getSecret());
			break;
		...
		case getSystemService:
			if (param.args.length > 0 && param.args[0] instanceof String && param.getResult() != null) {
				...
				EBXPrivacy.handleGetSystemService(name, instance.getClass().getName(), getSecret());
			}
			break;
		}
	}
