...
public class UpdateService extends Service {
	...
	public static final String cFlush = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.FLUSH";
	public static final String cUpdate = "edu.umbc.cs.ebiquity.mithril.ebxprivacy.action.UPDATE";
